	...
	const XssAttackModal = () => (
		...
		>
			<div className='mb-3 bg-black/40 p-3 rounded'>
				<Text size='sm' className='mb-2 font-bold flex items-center'>
			...
			<Text size='xs' className='italic mb-4'>
			...
			<Container size='xl' className='flex-grow flex flex-col justify-center'>
				...
				<SimpleGrid cols={3} spacing='lg'>
					<Paper withBorder p='lg' radius='md' className='bg-red-800/30 text-white'>
						...
						<Title order={5} className='mb-2 flex items-center'>
						...
						{showLoginForm ? (
							<>
								<form onSubmit={handleLogin}>
									...
									<PasswordInput label='Adgangskode' placeholder='Indtast adgangskode' required value={password} onChange={(e) => setPassword(e.target.value)} className='mb-4' />
									...
									<Button type='submit' fullWidth color='red' className='mb-3'>
										Log ind (Usikkert)
									</Button>
								</form>
...
Adgangskode: anything`}
						...
						<Text size='xs' className='text-center mt-4 text-red-300'>
					...
					<Paper withBorder p='lg' radius='md' className='bg-red-800/30 text-white'>
						...
						<Title order={5} className='mb-2 mt-4'>
							SQL Injection
						</Title>
						<Text size='sm' className='mb-3'>
						...
						<Text size='xs' className='mt-3 italic'>
